    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-black to-gray-950 text-white">
      ...
      <div className="container mx-auto px-4 md:px-8 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert prose-lg mx-auto bg-gray-900/50 p-6 md:p-8 rounded-lg border border-gray-700/80">
          ...
          <p>
            By using RacePaceOracle (the "Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of the terms, then you do not have permission to access the Service.
          </p>
          ...
          <p>
            The Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of RacePaceOracle and its licensors. The Service is protected by copyright, trademark, and other laws of both the [Your Country] and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of RacePaceOracle.
          </p>
           <p>
            Formula 1 related data is sourced from publicly available APIs (e.g., FastF1 library) and is subject to their respective terms and conditions. RacePaceOracle is not affiliated with Formula One group companies. F1, FORMULA ONE, FORMULA 1, FIA FORMULA ONE WORLD CHAMPIONSHIP, GRAND PRIX and related marks are trade marks of Formula One Licensing B.V.
          </p>
          ...
          <p>
            In no event shall RacePaceOracle, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.
          </p>
          ...
          <h2>11. Contact Us</h2>
          <p>
            If you have any questions about these Terms, please contact us at contact@racepaceoracle.app
          </p>
        </div>
      </div>
    </div>
