...
const faqs = [
  {
    question: "What data sources does RacePaceOracle use?",
    answer: "RacePaceOracle primarily uses the FastF1 Python library, which accesses publicly available Formula 1 timing data, weather data, and session information. Data accuracy is dependent on these upstream sources.",
  },
  {
  ...
  {
    question: "Is RacePaceOracle affiliated with Formula 1?",
    answer: "No, RacePaceOracle is an independent project and is not affiliated with, endorsed by, or associated with Formula One group companies. F1, FORMULA ONE, FORMULA 1, FIA FORMULA ONE WORLD CHAMPIONSHIP, GRAND PRIX and related marks are trade marks of Formula One Licensing B.V.",
  },
  {
