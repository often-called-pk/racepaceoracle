    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-black to-gray-950 text-white">
      ...
      <div className="container mx-auto px-4 md:px-8 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert prose-lg mx-auto bg-gray-900/50 p-6 md:p-8 rounded-lg border border-gray-700/80">
          ...
          <p>
            Welcome to RacePaceOracle ("we", "us", "our"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us.
          </p>
          ...
          <p>
            If you have questions or comments about this notice, you may email us at contact@racepaceoracle.app
          </p>
