  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome back to RacePaceOracle!",
        variant: "default",
      });
      navigate('/dashboard');
      ...
      <div className="w-full max-w-md mt-20">
        <div className="mb-8 text-center">
          <Link to="/" className="inline-flex items-center gap-2 text-white hover:text-red-500 transition-colors mb-4">
            ...
            <span className="font-bold text-3xl">Race<span className="text-red-500">PaceOracle</span></span>
          </Link>
              ...
              {!signupSuccess ? (
                <form onSubmit={handleSignup}>
                  <CardHeader className="pb-4">
                    ...
                    <CardDescription className="text-gray-400">
                      Join RacePaceOracle for premium F1 analytics and insights
                    </CardDescription>
