...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { name: 'Mail', href: 'mailto:contact@racepaceoracle.app', icon: <Mail className="h-5 w-5" /> },
  ];
      ...
      <div className="container mx-auto py-10 px-4 md:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="col-span-2 lg:col-span-2 space-y-4">
            <Link to="/dashboard" className="flex items-center gap-2 text-white hover:text-red-500 transition-colors mb-2 w-fit">
              ...
              <span className="font-bold text-xl">Race<span className="text-red-500">PaceOracle</span></span>
            </Link>
        ...
        <div className="mt-8 pt-6 border-t border-gray-700/50 flex flex-col sm:flex-row justify-between items-center text-xs">
          <p className="text-gray-500 mb-2 sm:mb-0">
            &copy; {currentYear} RacePaceOracle. All rights reserved.
          </p>
        ...
        <div className="mt-4 pt-4 border-t border-gray-700/50 text-xs text-center">
          <p className="text-gray-500">
            RacePaceOracle is not affiliated, associated, authorized, endorsed by, or in any way officially connected with 
