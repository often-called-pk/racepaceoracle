    ...
    <div className={cn(
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-300 mb-3">Connect with other F1 fans, discuss races, share analysis, and get the latest updates from the RacePaceOracle team. We're building a community of passionate Formula 1 fans who love data.</p>
